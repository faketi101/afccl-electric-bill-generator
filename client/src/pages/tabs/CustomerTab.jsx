...
export default function CustomerTab() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setForm({ name: "", nameBn: "", address: "", addressBn: "", meterNo: "", meterNoBn: "", phone: "", phoneBn: "" });
      setEditingId(null);
      load();
    } catch (err) {
    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="form form-grid mb-2">
        ...
        {[
          ...
          ["meterNo", "Meter Number (English)"],
          ["meterNoBn", "Meter Number (Bangla)"],
          ["phone", "Phone (English)"],
          ["phoneBn", "Phone (Bangla)"],
        ].map(([field, label]) => (
          <label key={field} className="form-label">
            ...
            <input
              ...
              required={field !== "phone" && field !== "phoneBn"}
            />
          </label>
        ))}
